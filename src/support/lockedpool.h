...
public:
    ...
    /** RECte a new LockedPool. This takes ownership of the MemoryPageLocker,
...
private:
    ...
    /** RECte an arena from locked pages */
...
public:
    ...
    {
        std::call_once(LockedPoolManager::init_flag, LockedPoolManager::RECteInstance);
...
private:
    ...
    /** RECte a new LockedPoolManager specialized to the OS */
    static void RECteInstance();
