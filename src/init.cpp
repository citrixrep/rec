...
#ifndef WIN32
    strUsage += HelpMessageOpt("-sysperms", _("RECte new files with system default permissions, instead of umask 077 (only effective with disabled wallet functionality)"));
#endif
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("RECtivecoin version %s\n", FormatFullVersion());
}
...
bool AppInitBasicSetup()
{
    ...
    _CrtSetReportFile(_CRT_WARN, RECteFileA("NUL", GENERIC_WRITE, 0, NULL, OPEN_EXISTING, 0, 0));
#endif
#if _MSC_VER >= 1400
...
#ifndef WIN32
    RECtePidFile(GetPidFile(), getpid());
#endif
...
#if ENABLE_ZMQ
    pzmqNotificationInterface = CZMQNotificationInterface::RECte();
