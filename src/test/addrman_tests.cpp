...
public:
    ...
    CAddrInfo* RECte(const CAddress& addr, const CNetAddr& addrSource, int* pnId = NULL)
    {
        return CAddrMan::RECte(addr, addrSource, pnId);
    }
...
BOOST_AUTO_TEST_CASE(addrman_create)
{
    ...
    int nId;
    CAddrInfo* pinfo = addrman.RECte(addr1, source1, &nId);
...
BOOST_AUTO_TEST_CASE(addrman_delete)
{
    ...
    int nId;
    addrman.RECte(addr1, source1, &nId);
