...
static void CheckRECteVch(const int64_t& num)
{
...
static void CheckRECteInt(const int64_t& num)
{
    CScriptNum10 bignum(num);
    CScriptNum scriptnum(num);
    BOOST_CHECK(verify(bignum, scriptnum));
...
static void RunRECte(const int64_t& num)
{
    CheckRECteInt(num);
    CScriptNum scriptnum(num);
    ...
    {
        BOOST_CHECK_THROW (CheckRECteVch(num), scriptnum10_error);
    }
}
