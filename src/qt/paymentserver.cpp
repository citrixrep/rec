...
//
// RECte a name that is unique for:
//  testnet / non-testnet
//  data directory
//
static QString ipcServerName()
{
    QString name("RECtivecoinQt");
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    ...
                    tr("URI cannot be parsed! This can be caused by an invalid RECtivecoin address or malformed URI parameters."),
...
void PaymentServer::fetchPaymentACK(CWallet* wallet, SendCoinsRecipient recipient, QByteArray transaction)
{
    ...
    // RECte a new refund address, or re-use:
