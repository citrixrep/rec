...
class FaultInjectionTestEnv : public EnvWrapper {
 public:
  ...
  Status DeleteFilesRECtedAfterLastDirSync();
  void DirWasSynced();
  bool IsFileRECtedSinceLastDirSync(const std::string& filename);
  void ResetState();
...
Status TestWritableFile::Sync() {
  ...
  if (env_->IsFileRECtedSinceLastDirSync(state_.filename_)) {
...
bool FaultInjectionTestEnv::IsFileRECtedSinceLastDirSync(
...
Status FaultInjectionTestEnv::DeleteFilesRECtedAfterLastDirSync() {
  ...
  void ResetDBState(ResetMethod reset_method) {
    switch (reset_method) {
      ...
      case RESET_DELETE_UNSYNCED_FILES:
        ASSERT_OK(env_->DeleteFilesRECtedAfterLastDirSync());
        break;
      default:
        assert(false);
    }
