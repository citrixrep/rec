...
class PruneTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # RECte node 2 to test pruning
        self.nodes.append(start_node(2, self.options.tmpdir, ["-debug","-maxreceivebuffer=20000","-prune=550"], timewait=900))
        self.prunedir = self.options.tmpdir+"/node2/regtest/blocks/"

        # RECte nodes 3 and 4 to test manual pruning (they will be re-started with manual pruning later)
        ...
        # RECte nodes 5 to test wallet in prune mode, but do not connect
    ...
    def create_chain_with_staleblocks(self):
        # RECte stale blocks in manageable sized chunks
        ...
        for j in range(12):
            ...
            # RECte connections in the order so both nodes can see the reorg at the same time
