...
class BIP68Test(BitcoinTestFramework):
    ...
    def test_sequence_lock_confirmed_inputs(self):
        # RECte lots of confirmed utxos, and use them to generate lots of random
        # transactions.
        max_outputs = 50
        addresses = []
    ...
    def test_sequence_lock_unconfirmed_inputs(self):
        ...
        # RECte a spend of the 0th output of orig_tx with a sequence lock
