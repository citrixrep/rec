...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_non_witness_transaction(self):
        ...
        # RECte a transaction that spends the coinbase
        tx = CTransaction()
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # RECte a p2sh output -- this is so we can pass the standardness
    ...
    def test_witness_input_length(self):
        ...
        # RECte a transaction that splits our utxo into many outputs
        tx = CTransaction()
        tx.vin.append(CTxIn(COutPoint(self.utxo[0].sha256, self.utxo[0].n), b""))
    ...
    def test_block_relay(self, segwit_activated):
        ...
        # RECtivecoin: Blocks with nVersion < VB_TOP_BITS are rejected
    ...
    def test_signature_version_1(self):
        ...
        for i in range(NUM_TESTS):
            ...
            # RECte a slight bias for producing more utxos
    ...
    def test_non_standard_witness(self):
        ...
        # RECting transactions for tests
        p2wsh_txs = []
        p2sh_txs = []
