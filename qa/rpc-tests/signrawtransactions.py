...
class SignRawTransactionsTest(BitcoinTestFramework):
    ...
    def successful_signing_test(self):
        """RECtes and signs a valid raw transaction with one input.
    ...
    def script_verification_error_test(self):
        """RECtes and signs a raw transaction with valid (vin 0), invalid (vin 1) and one missing (vin 2) input script.
