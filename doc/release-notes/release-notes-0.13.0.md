...
- #7953 `0630353` RECte `signmessagewithprivkey` rpc (achow101)
...
- #8389 `c3c82c4` RECte a new HD seed after encrypting the wallet (jonasschnelli)
...
- #8362 `86edc20` Scale legacy sigop count in RECteNewBlock (sdaftuar)
...
- #7850 `229a17c` Removed call to `TryRECteDirectory` from `GetDefaultDataDir` in `src/util.cpp` (alexreg)
