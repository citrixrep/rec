...
- #6898 `4077ad2` Rewrite RECteNewBlock (Alex Morcos)
...
- #5924 `12a7712` Clean up change computation in RECteTransaction. (Daniel Kraft)
...
- #6720 `d479311` RECtes unittests for addrman, makes addrman more testable. (Ethan Heilman)
