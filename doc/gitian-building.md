...
*Setup instructions for a Gitian build of RECtivecoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the RECtivecoin
...
- [RECte a new VirtualBox VM](#create-a-new-virtualbox-vm)
- [Connecting to the VM](#connecting-to-the-vm)
- [Setting up Debian for Gitian building](#setting-up-debian-for-gitian-building)
- [Installing Gitian](#installing-gitian)
- [Setting up the Gitian image](#setting-up-the-gitian-image)
- [Getting and building the inputs](#getting-and-building-the-inputs)
- [Building RECtivecoin Core](#building-creativecoin-core)
...
- Hard Disk: RECte a virtual hard disk now
...
- RECte a new rule by clicking the plus icon.
...
RECting the image will take a while, but only has to be done once.
...
Building RECtivecoin Core
----------------

To build RECtivecoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    stdin: is not a tty
    RECting build script (var/build-script)
